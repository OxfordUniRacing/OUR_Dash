...
class Toplevel1:
    ...
    def dataUpdate(self, index):
        with open('TestFile.csv') as data_file:
            ...
            self.csv_reader = []
            for row in csv_read:
                self.csv_reader.append(int(row[index]))
    ...
    def gifUpdate(self):
        ...
        #for k in range(0, 2):
        for gif in range(len(self.frames)):
            self.Canvas1.delete(self.gif_id)
            self.gif_id = self.Canvas1.create_image(200, 200, image=self.frames[gif], anchor= 'ne', state = 'normal')
            time.sleep(0.01)
    ...
    def speedUpdate(self):
        ...
        self.arrowIm_id = self.Canvas1.create_image(915,80, image=self.arrowIm, anchor='ne', state='normal')
    ...
    def battUpdate(self):
        ...
        #Get and set new
        self.battTemp = self.csv_reader[1]
    ...
    def motorTempUpdate(self):
        ...
        #New
        self.motorTemp = self.csv_reader[2]
    ...
    def __init__(self, top=None):
        ...
        #GIF
        frameCnt = 80
        #self.frames = [PhotoImage(file=r"OURlogo.gif", format = 'gif -index %i' %(i)) for i in range(frameCnt)]
        #self.gif_id = self.Canvas1.create_image(0, 0, image=self.frames[0], anchor= 'ne', state='normal')
